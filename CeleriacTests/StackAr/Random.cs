    ...
    public class Random
    {
        private static int A = 48271;
        private static int M = 2147483647;
        private static int Q = M / A;
         ...
         */
        public Random( ) : this ((int) System.DateTime.Now.ToBinary() % System.Int32.MaxValue)
        {
        }
        ...
        public static void main( string [ ] args )
        {
            ...
            for( int i = 0; i < 20; i++ )
                System.Console.WriteLine( r.randomInt( ) );
        }
    }
